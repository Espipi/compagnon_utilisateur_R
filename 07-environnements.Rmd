...
# Environnements and scoping{#environnement}  
...
Dans les faits, un environnent n'est rien d'autre qu'une liste (voir chapitre \@ref(Structures) pour plus de détails) dans laquelle on enregistre des objets. Lorsque l'on ouvre R et que l'on créé un objet, il est ajouté à l'environnement global. 
